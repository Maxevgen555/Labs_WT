// Labs.Tests/ProductControllerTests.cs
...
namespace Labs.Tests
{
    public class ProductControllerTests
    {
        ...
        public async Task IndexSetsCorrectCurrentCategory()
        {
            ...
            var currentCategory = categoriesResponse.Data[0];
            var controller = new ProductController(_productService, _categoryService);
        ...
        // В случае ошибки возвращается NotFoundObjectResult с правильным содержимым
        [Fact]
        ...
        void SetupData()
        {
            ...
            _productService.GetProductListAsync(Arg.Any<string?>(), Arg.Any<int>(), Arg.Any<int>())
